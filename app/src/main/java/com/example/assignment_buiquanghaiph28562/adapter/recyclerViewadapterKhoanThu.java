...
public class recyclerViewadapterKhoanThu extends RecyclerView.Adapter<recyclerViewadapterKhoanThu.logoViewHolder>  {
    private Context mContext;
    private ArrayList<khoanchi_class> mArrayList;
    private database mDatabase;
    private deleteListionner listionner;

    public recyclerViewadapterKhoanThu(Context mContext, deleteListionner listionner) {
    ...
    public void onBindViewHolder(@NonNull logoViewHolder holder, int position) {
         ...
         public void onClick(View v) {
             ...
             mBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                 ...
                 public void onClick(DialogInterface dialog, int which) {
                     ...
                     mDatabase.queryData("DELETE FROM khoanthu WHERE GD='"+thu.getGD()+"'");
     ...
     holder.imgedit.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View v) {
             ...
             textView.setText("EDIT KHOẢN THU");
             btnedit.setText("Sửa");
                         ...
                         public void onClick(DialogInterface dialog, int which) {
                             try {
                                if (edtthu.getText().toString().isEmpty()){
                                    ...
                                    float thu1=Float.parseFloat(edtthu.getText().toString());
                                    mDatabase=new database(mContext);
                                    mDatabase.queryData("UPDATE khoanthu SET name = '"+thu1+"' WHERE GD='"+thu.getGD()+"'");
                                    listionner.deletedatabase();
                                    dialog1.dismiss();
                                }
                             }catch (Exception e){
